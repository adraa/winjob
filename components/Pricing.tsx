...
const Pricing: React.FC = () => {
    ...
    return (
        <section id="pricing" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-lime-400">
            <div className="container mx-auto max-w-4xl">
                <div className="relative bg-black border-4 border-white p-8 sm:p-12 text-center shadow-[8px_8px_0px_#FFFFFF]">
                    
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div className="bg-black text-lime-400 font-bold uppercase tracking-widest px-6 py-2 -rotate-3 border-2 border-white">
                            Limited-Time Launch Offer
                        </div>
                    </div>
                    
                    <h2 className="text-4xl sm:text-5xl font-bold tracking-tighter uppercase pt-8 text-white">Get Your eBook Instantly</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 text-left my-10 max-w-2xl mx-auto">
                        {features.map((feature, index) => (
                         ...
                         <div className="flex items-center space-x-3 sm:col-span-2 justify-center bg-lime-900/50 p-3 mt-4 border-2 border-dashed border-lime-400">
                    ...
                    {/* PRODUCTION: Replace '#' with your actual payment link (e.g., Stripe, Gumroad) */}
                    <a
                        href="#"
                        className="inline-flex items-center justify-center space-x-3 text-xl font-bold px-12 py-5 bg-lime-400 text-black border-2 border-black shadow-[4px_4px_0px_#FFFFFF] hover:shadow-none hover:translate-x-1 hover:translate-y-1 w-full sm:w-auto"
                    >
